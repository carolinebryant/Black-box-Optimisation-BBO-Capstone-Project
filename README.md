...
The README currently describes the project at a high level but doesn't capture the surrogate modelling approach, acquisition strategy, or the reasoning behind key design decisions.
